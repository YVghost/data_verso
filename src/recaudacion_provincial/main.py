"""
Fuente  : SRI - Recaudación Provincial
...
Instrucción : Apartado Recaudación > "Valores recaudados mensualmente (provincia y
              ...
              Columnas clave: I "PROVINCIA", L "VALOR_RECAUDADO".
"""
...
def extract_fixed_range(start_year: int, end_year: int):
    """Extrae recaudación provincial entre start_year y end_year."""
...
def extract_to_current():
    """Extrae recaudación provincial desde 2018 hasta el año en curso."""
    df = bot.download()
    loader.load(df)
    return df
...
def extract_to_specific_date(target_year: int):
    """Extrae recaudación provincial hasta target_year."""
